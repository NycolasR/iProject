...
public class ValidadoraDatas {
	...
	public static boolean validarDataHojeMenorQueDataRecebida(LocalDate data) {
		...
		if(dataAgora.equals(data) || dataAgora.isBefore(data) ) {
			return true;
		}else {
			return false;
		}
	 ...
	 */
	public static boolean dataEntradaisIgualDataSaidaDePontoTrabalhado(LocalDateTime dataHora1, LocalDateTime dataHora2) {
