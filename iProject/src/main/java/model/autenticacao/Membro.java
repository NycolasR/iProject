...
//		no metodo remover membro da classe Grupo.
	...
	public void setMatricula(long matricula) {
		if(Long.toString(matricula).length() != 9)
			throw new UnsupportedOperationException("[ERRO] As matr�culas devem ter 9 d�gitos.");
	...
	public void setEmail(String email) {
		if(!ValidadoraFormatoEmailLogin.validarLoginComum(email))
			throw new UnsupportedOperationException("[ERRO] O email n�o possui um formato v�lido");
